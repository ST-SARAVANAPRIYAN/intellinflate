...
* ✅ Abnormal pressure drop detection (Current PSI vs Last PSI)
* ✅ Full mobile application focus
* ✅ Updated architecture and modules

You can directly save this as `README.md`.
